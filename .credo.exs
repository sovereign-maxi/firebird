# FireBird — Credo Configuration (STRICT MODE)
#
# Run: mix credo --strict
#
# ALL warnings are errors. This MUST pass with zero issues.
    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          {Credo.Check.Design.DuplicatedCode, [mass_threshold: 50]},
          {Credo.Check.Design.TagFIXME, [exit_status: 2]},
          # TODOs allowed but tracked
          ...
          {Credo.Check.Refactor.IoPuts, [files: %{excluded: [~r"/test/"]}]},
          ...
          {Credo.Check.Refactor.PipeChainStart,
           [
             ...
             excluded_argument_types: [:binary, :fn, :keyword, :atom]
           ]},
          ...
          {Credo.Check.Warning.UnsafeToAtom, [files: %{excluded: [~r"/test/"]}]},
